<x-layouts::app :title="__('AI Predictions')">
    <section class="eco-page-palette eco-page-hero eco-page-hero--sky space-y-6 rounded-[0.35rem] border border-sky-200 bg-sky-50/60 p-4 dark:border-sky-900/40 dark:bg-sky-950/20 sm:p-6">
        <div>

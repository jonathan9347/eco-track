<x-layouts::app :title="__('About Us')">
    <div class="eco-page-palette mx-auto flex w-full max-w-6xl flex-col gap-6">
        ...
        <section class="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <article class="eco-page-card eco-page-card--teal border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-none" style="border-radius: 0.35rem !important;">
        ...
        <section class="grid gap-6 md:grid-cols-3">
            ...
            <article class="eco-page-card eco-page-card--lime border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-none" style="border-radius: 0.35rem !important;">
